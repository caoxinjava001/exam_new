...
class Kemucate extends MY_Controller{
    ...
    public function index(){
        ...
        $res=$this->exam_tag_kemu_model->list_info('*',$this->where,$this->page,$this->perpage);
        $data['data']=$res;
        $data['s_name']=$s_name;
        $data['login_role']=$this->login_role;
        $data['pages']=pages($this->exam_tag_kemu_model->getCount($this->where),$this->page,$this->perpage);

        $this->rendering_admin_template($data,'kemu_tag','class_list');
    ...
    public function create(){
        $data=array();
        $this->rendering_admin_template($data,'kemu_tag','class_create');
    }
    ...
    public function edit(){
        ...
        $data_info=$this->exam_tag_kemu_model->get_one('*',$where);
    ...
    public function createCard(){
        ...
        //执行插入
        if(!$id){
            $r = $this->exam_tag_kemu_model->insert($post_data,true);
            $msg = '创建成功！';
        }else{
            $r = $this->exam_tag_kemu_model->update($post_data,'id ='.$id);
            $msg = '修改成功！';
        }
    ...
    public function deleteAgent(){
        ...
        $bool=$this->exam_tag_kemu_model->update($data,$where);
