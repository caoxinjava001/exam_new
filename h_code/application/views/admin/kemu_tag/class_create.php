<div class="crumb-wrap">
    <div class="crumb-list"><i class="icon-font"></i><a href="/admin">首页</a><span class="crumb-step">&gt;</span><a href="/kemucate/index"><span class="crumb-name">试卷科目分类列表</span></a></div>
</div>
...
<div class="xu" id="xu">
    <div class="cont_left">
        <div class="cont_demand">
            <p class="demand_p1"><?php echo $data_info['id']?'修改科目分类':'增加科目分类';?></p>
        </div>
        <form id="card_add">
    ...
    $('#createCard').bind('click',function(){
        ...
        if(nb.length<1){
            ...
            if(is_sub){
                ...
                obj.data = up_data;
                obj.type = 'post';
                obj.url = config.domain.wf+'/kemucate/createCard';
