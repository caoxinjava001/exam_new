    ...
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                <!--<li><a href="<?php echo  MAIN_PATH;?>/manage/index?id=<?php echo $this->mid;?>"><?php echo $org_name; ?></a></li>-->
                <li><a href="<?php echo  MAIN_PATH;?>/manage/edit?id=<?php echo $this->mid;?>"><?php echo $org_name; ?></a></li>
                <!--<li><a href="#">修改密码</a></li>-->
