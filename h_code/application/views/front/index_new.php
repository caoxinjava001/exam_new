...
href="<?php echo STATICS_PATH;?>/shiti_two/in/mokaoba.css">
...
<DIV class=navInner><SPAN class=homeIco><A class=myTest href="#" >考试中心</A> | <A class=myTest href="#" >会员中心</A><A class=sina href="#" ></A> </SPAN><SPAN id=ks110_LoginView 
class=login>欢迎来到清大网校<A href="#">登录</A><A href="#" >免费注册</A> </SPAN></DIV>
</DIV>
<DIV class="banner ">
  ...
  <tr>
	...
	<table width="364" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="81" align="center"><img src="<?php echo STATICS_PATH;?>/shiti_two/in/s4.jpg" width="52" height="30" /></td>
              </tr>
      </table>
  ...
  <tr>
    <td><table width="960" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #CCCCCC;">
      ...
      <tr>
        ...
        <td align="left" style="font-size:12px; color:#fd7460" class="in_tit"><span style=" float:left;color:#4c7d9c;">全部类型</span>
...
<DIV class=bread><SPAN>您的位置：</SPAN><A href="#">清大网校在线考试中心</A>&nbsp;&gt; <A #href="#">学科</A> &nbsp;&gt;<A #href="#">语文</A> </DIV>
<table width="960" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td height="10"></td>
  </tr>
  <tr>
    <td align="left" background="<?php echo STATICS_PATH;?>/shiti_two/in/24.png" style="padding:15px 20px; "><img src="<?php echo STATICS_PATH;?>/shiti_two/in/a1.png" width="518" height="82"></td>
  </tr>
  <tr>
    <td background="<?php echo STATICS_PATH;?>/shiti_two/in/24.png" style="padding:15px 20px; "><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="91%" valign="top"><table width="610" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #d9d5b5;">
          <tr>
            <td bgcolor="#FFFFFF" style="padding:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="line-height:25px; font-size:12px; border-bottom:1px dashed #CCCCCC;">&nbsp;&nbsp;&nbsp;&nbsp;在线测试系列集合了北大百年学习网网校最新推出的个性化互动网络学习系列产品，让每个学生通过练习发现自己的知识弱项，并针对知识弱项进行学习，提高学习效率和学习成绩！</td>
              </tr>
              <tr>
                <td style="padding:6px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="4%" height="26"><img src="<?php echo STATICS_PATH;?>/shiti_two/in/a4.png" width="16" height="17"></td>
                    <td width="96%" style="font-size:12px;">应用美国Real Learning Model和学习金字塔理论成果                    </td>
                  </tr>
                  <tr>
                    <td height="26"><img src="<?php echo STATICS_PATH;?>/shiti_two/in/a4.png" width="16" height="17"></td>
                    <td style="font-size:12px;">提供系统的在线练习方案，在练习中真正提高</td>
                  </tr>
                  <tr>
                    <td height="26"><img src="<?php echo STATICS_PATH;?>/shiti_two/in/a4.png" width="16" height="17"></td>
                    <td style="font-size:12px;">每周精选20题，覆盖每周的重点、难点、考点</td>
                  </tr>
                  <tr>
                    <td height="26"><img src="<?php echo STATICS_PATH;?>/shiti_two/in/a4.png" width="16" height="17"></td>
                    <td style="font-size:12px;">每题配有解析，不会的题有文字解析</td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
        ...
        <td width="9%"><img src="<?php echo STATICS_PATH;?>/shiti_two/in/a3.png" width="295" height="175" style="padding:5px; border:1px solid #d9d5b5; background:#FFFFFF;"></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left"><img src="<?php echo STATICS_PATH;?>/shiti_two/in/a6.png" width="960" height="69"></td>
  </tr>
    <tr>
    <td bgcolor="#f8fcfd" style="padding:20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
        <td width="230" align="left" valign="top"><table width="160" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="164" valign="top" background="<?php echo STATICS_PATH;?>/shiti_two/in/a7.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="40" align="center" style="color:#FFFFFF; font-weight:bold;">高中一年级</td>
              </tr>
              <tr>
                <td style="line-height:25px; font-size:12px; padding:0 8px;">文言虚词辨析假期保温文言实词理解假期保温词语和病句辨析假期保</td>
              </tr>
              <tr>
                <td align="center"><a 
            href="/examination/index?id=2&user_name=<?php echo $user_name; ?>&user_id=<?php echo $user_id; ?>" 
><img src="<?php echo STATICS_PATH;?>/shiti_two/in/a8.png" width="91" height="27" border="0"></a></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
        <td width="230" align="left" valign="top"><table width="160" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="164" valign="top" background="<?php echo STATICS_PATH;?>/shiti_two/in/a7.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="40" align="center" style="color:#FFFFFF; font-weight:bold;">高中二年级</td>
                </tr>
                <tr>
                  <td style="line-height:25px; font-size:12px; padding:0 8px;">文言虚词辨析假期保温文言实词理解假期保温词语和病句辨析假期保</td>
                </tr>
                <tr>
                  <td align="center"><a href="#"><img src="<?php echo STATICS_PATH;?>/shiti_two/in/a8.png" width="91" height="27" border="0"></a></td>
                </tr>
            </table></td>
          </tr>
        </table></td>
        <td align="left" valign="top"><table width="160" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="164" valign="top" background="<?php echo STATICS_PATH;?>/shiti_two/in/a7.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="40" align="center" style="color:#FFFFFF; font-weight:bold;">高中三年级</td>
                </tr>
                <tr>
                  <td style="line-height:25px; font-size:12px; padding:0 8px;">文言虚词辨析假期保温文言实词理解假期保温词语和病句辨析假期保</td>
                </tr>
        ...
        <td width="230" align="left" valign="top"><table width="160" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="164" valign="top" background="<?php echo STATICS_PATH;?>/shiti_two/in/a9.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="40" align="center" style="color:#FFFFFF; font-weight:bold;">初中一年级</td>
                </tr>
                <tr>
                  <td style="line-height:25px; font-size:12px; padding:0 8px;">文言虚词辨析假期保温文言实词理解假期保温词语和病句辨析假期保</td>
                </tr>
      ...
      <tr>
        <td align="left" valign="top"><table width="160" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="164" valign="top" background="<?php echo STATICS_PATH;?>/shiti_two/in/a9.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="40" align="center" style="color:#FFFFFF; font-weight:bold;">初中二年级</td>
                </tr>
                <tr>
                  <td style="line-height:25px; font-size:12px; padding:0 8px;">文言虚词辨析假期保温文言实词理解假期保温词语和病句辨析假期保</td>
                </tr>
        ...
        <td align="left" valign="top"><table width="160" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="164" valign="top" background="<?php echo STATICS_PATH;?>/shiti_two/in/a9.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="40" align="center" style="color:#FFFFFF; font-weight:bold;">初中三年级</td>
                </tr>
                <tr>
                  <td style="line-height:25px; font-size:12px; padding:0 8px;">文言虚词辨析假期保温文言实词理解假期保温词语和病句辨析假期保</td>
                </tr>
        ...
        <td align="left" valign="top"><table width="160" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="164" valign="top" background="<?php echo STATICS_PATH;?>/shiti_two/in/a10.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="40" align="center" style="color:#FFFFFF; font-weight:bold;">小学一年级</td>
                </tr>
                <tr>
                  <td style="line-height:25px; font-size:12px; padding:0 8px;">文言虚词辨析假期保温文言实词理解假期保温词语和病句辨析假期保</td>
                </tr>
        ...
        <td align="left" valign="top"><table width="160" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="164" valign="top" background="<?php echo STATICS_PATH;?>/shiti_two/in/a10.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="40" align="center" style="color:#FFFFFF; font-weight:bold;">小学二年级</td>
                </tr>
                <tr>
                  <td style="line-height:25px; font-size:12px; padding:0 8px;">文言虚词辨析假期保温文言实词理解假期保温词语和病句辨析假期保</td>
                </tr>
      ...
      <tr>
        <td align="left" valign="top"><table width="160" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="164" valign="top" background="<?php echo STATICS_PATH;?>/shiti_two/in/a10.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="40" align="center" style="color:#FFFFFF; font-weight:bold;">小学三年级</td>
                </tr>
                <tr>
                  <td style="line-height:25px; font-size:12px; padding:0 8px;">文言虚词辨析假期保温文言实词理解假期保温词语和病句辨析假期保</td>
                </tr>
        ...
        <td align="left" valign="top"><table width="160" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="164" valign="top" background="<?php echo STATICS_PATH;?>/shiti_two/in/a10.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="40" align="center" style="color:#FFFFFF; font-weight:bold;">小学四年级</td>
                </tr>
                <tr>
                  <td style="line-height:25px; font-size:12px; padding:0 8px;">文言虚词辨析假期保温文言实词理解假期保温词语和病句辨析假期保</td>
                </tr>
        ...
        <td align="left" valign="top"><table width="160" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="164" valign="top" background="<?php echo STATICS_PATH;?>/shiti_two/in/a10.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="40" align="center" style="color:#FFFFFF; font-weight:bold;">小学五年级</td>
                </tr>
                <tr>
                  <td style="line-height:25px; font-size:12px; padding:0 8px;">文言虚词辨析假期保温文言实词理解假期保温词语和病句辨析假期保</td>
                </tr>
        ...
        <td align="left" valign="top"><table width="160" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="164" valign="top" background="<?php echo STATICS_PATH;?>/shiti_two/in/a10.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="40" align="center" style="color:#FFFFFF; font-weight:bold;">小学六年级</td>
                </tr>
                <tr>
                  <td style="line-height:25px; font-size:12px; padding:0 8px;">文言虚词辨析假期保温文言实词理解假期保温词语和病句辨析假期保</td>
                </tr>
