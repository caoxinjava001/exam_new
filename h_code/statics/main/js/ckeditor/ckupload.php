...
$day = date("d",$now_time);
$real_path_one = "/var/web/exam/h_code/statics/uploads/";
...
$url = 'http://182.92.72.93:9010/statics/uploads'.$show_real_val;
echo "<script type='text/javascript'>document.domain='182.92.72.93';window.parent.CKEDITOR.tools.callFunction($funcNum, '$url', '$message');</script>";
?>
